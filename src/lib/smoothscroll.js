define(["dojo/_base/kernel","dojo/_base/lang", "dojo/_base/fx", "DojoXScroll/lib/_base","DojoXScroll/lib/_core","dojo/dom-geometry","dojo/_base/sniff"],
	...
	fxExt.smoothScroll = function(/* Object */args){
		...
		if(!isWindow){
			...
			delta.x -= winPos.x;
			// 20180221 - Ivo Sturm - changed to using args.offset. Else was not working in IE
		...
		var anim = new baseFx.Animation(lang.mixin({
			beforeBegin: function(){
				...
				anim.curve = new Line([current.x,args.offset.y],[current.x + delta.x, current.y - delta.y]);
			},
			onAnimate: _anim
		},args));
